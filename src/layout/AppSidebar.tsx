...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Page 11: Join Sleeper League (Joiner)", path: "/"},
      { name: "Page 12: Connect Wallet (Joiner)", path: "/"},
      { name: "Page 13: Top Up USDC (Joiner)", path: "/"},
      { name: "Page 14: Join League (Joiner)", path: "/"},
